class Announcement {
  ...
  factory Announcement.fromJson(Map<String, dynamic> json) {
    final serviceArea = json['service_areas'];
    ...
    if (rawTranslations is Map<String, dynamic>) {
      for (final entry in rawTranslations.entries) {
        if (entry.value is Map<String, dynamic>) {
          translations[entry.key] = AnnouncementTranslation.fromJson(
    ...
    return Announcement(
      ...
      serviceAreaName: serviceArea is Map<String, dynamic>
          ? serviceArea['name'] as String?
          : null,
