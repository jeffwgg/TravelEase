...
/// An accessibility-first, premium travel app for deaf and hard-of-hearing travelers.

class AppColors {
  // Primary — Calm Teal (trust, accessibility, travel)
  static const primary = Color(0xFF0D9488);
  static const primaryLight = Color(0xFF5EEAD4);
  static const primaryDark = Color(0xFF0F766E);

  // Secondary — Warm Amber (urgency, alerts, warmth)
  ...
  // Accent — Deep Indigo (trust, professionalism)
