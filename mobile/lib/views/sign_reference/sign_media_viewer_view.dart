                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ...phrase.orderedTextsWithLanguage(dialect).indexed.map((e) {
                        final (i, pair) = e;
                        final (text, lang) = pair;
                        final style = switch (i) {
                          0 => Theme.of(context).textTheme.headlineLarge,
                          1 => Theme.of(context).textTheme.titleMedium?.copyWith(color: AppColors.textSecondary),
                          _ => const TextStyle(fontSize: 14, color: AppColors.textMuted),
                        };
                        final isSpeakingThis = _viewModel.isSpeaking && _viewModel.speakingLang == lang;
                        return Padding(
                          padding: EdgeInsets.only(top: i == 0 ? 0 : i == 1 ? 4 : 2),
                          child: Row(
                            ...
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: _viewModel.isSpeaking ? null : () => _viewModel.speakAloud(text: text, language: lang),
                              ),
                            ],
                          ),
                        );
      ...
      return Center(
        child: Padding(
          ...
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              const Icon(Icons.videocam_off_rounded, size: 56, color: Colors.white30),
              const SizedBox(height: 12),
              Text(
      ...
      return const Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 12),
            Text('Loading sign video…', style: TextStyle(color: Colors.white60, fontSize: 12)),
          ],
        ),
      );
    }
