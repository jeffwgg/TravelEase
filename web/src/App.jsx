  ...
  return (
    <div className="app-layout">
      ...
      <main className="main-content">
        {children}
        <div className="ai-assistant-btn" title="AI Assistant">
          <Zap className="ai-icon" size={24} style={{ display: 'none' }} />
          <svg className="ai-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
